...
#[openapi(
    ...
    paths(
        ...
        crate::security::interface::post_create_service_account,
        crate::security::interface::get_list_service_accounts,
        crate::security::interface::get_service_account,
        crate::security::interface::delete_service_account_handler,
        crate::security::interface::post_create_api_key,
        crate::security::interface::get_list_api_keys,
        crate::security::interface::delete_api_key_handler,
        crate::security::interface::post_rotate_api_key,
    ...
    components(
        schemas(
            ...
            crate::security::interface::CreateServiceAccountRequest,
            crate::security::interface::ServiceAccountResponse,
            crate::security::interface::ListServiceAccountsResponse,
            crate::security::interface::CreateApiKeyRequest,
            crate::security::interface::ApiKeyResponse,
            crate::security::interface::CreateApiKeyResponse,
